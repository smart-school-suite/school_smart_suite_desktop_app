...
const additionalFeeCategorySlice = createSlice({
  name: "additionalFeeCategory",
  initialState,
  reducers: {
...
export const {
  ...
  setImportReset,
  setColumnMapping
} = additionalFeeCategorySlice.actions;

export default additionalFeeCategorySlice.reducer;
