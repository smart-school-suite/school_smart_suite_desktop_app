...
const activationCodeTransactionSlice = createSlice({
  name: "activationCodeTransaction",
  initialState,
  reducers: {
...
} = activationCodeTransactionSlice.actions;

export default activationCodeTransactionSlice.reducer;
