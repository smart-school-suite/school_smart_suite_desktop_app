...
const resitExamTimetableSlice = createSlice({
    name: "resitExamTimetable",
    initialState: {
        formData: [],
        startDate: null,
        endDate: null,
...
export const { setData, setExamDateRange, updateField } = resitExamTimetableSlice.actions;
export default resitExamTimetableSlice.reducer;