...
const tuitionFeeScheduleSlice = createSlice({
  name: "tuitionFeeSchedule",
  initialState,
  reducers: {
    ...
    setSelectedSchedules: (state, action) => {
...
export const {
  ...
  setImportReset,
  setColumnMapping
} = tuitionFeeScheduleSlice.actions;

export default tuitionFeeScheduleSlice.reducer;
