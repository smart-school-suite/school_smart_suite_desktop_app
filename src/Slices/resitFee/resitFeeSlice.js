...
const resitFeeSlice = createSlice({
  name: "resitFee",
  initialState,
  reducers: {
    ...
    setSelectedResitFees: (state, action) => {
      state.selectedResitFees = action.payload;
    },
...
export const {
  ...
  setImportReset,
  setColumnMapping
} = resitFeeSlice.actions;

export default resitFeeSlice.reducer;
