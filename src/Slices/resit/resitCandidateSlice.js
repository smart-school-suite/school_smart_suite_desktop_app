...
const initialState = {
  resitCandidates: null,
  isGeneralFilterOpen: false,
  tableRef: null,
  selectedResitCandidates: [],
  rowCount: 0,
  searchText: "",
  columns: {
    selectedColumns: [],
...
const resitCandidateSlice = createSlice({
  name: "resitCandidate",
  initialState,
  reducers: {
    ...
    setSelectedCandidates: (state, action) => {
      state.selectedResitCandidates = action.payload;
    },
...
export const {
  ...
  setImportReset,
  setColumnMapping
} = resitCandidateSlice.actions;

export default resitCandidateSlice.reducer;
