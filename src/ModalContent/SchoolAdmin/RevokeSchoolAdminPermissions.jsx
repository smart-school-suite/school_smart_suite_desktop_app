...
const RevokeSchoolAdminPermissions = ({ row_id: schoolAdminId, handleClose }) => {
    const { data: data, isLoading, error} = useFetchPermissionsBySchoolAdminQuery({ schoolAdminId: schoolAdminId });
