...
import { useGetCaUpdateHelperData } from "../../hooks/evaluationHelper/useGetCaUpdateHelperData";
function UpdateCaScores({ handleClose, rowData }) {
  const moduleState = useSelector((state) => state.caEvaluation.update);
