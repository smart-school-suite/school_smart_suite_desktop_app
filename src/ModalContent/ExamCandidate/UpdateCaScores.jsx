...
function UpdateCaScores({ handleClose, rowData }){
  ...
  const { data:updateData, isFetching } = useGetCaExamScoresByCandidate(candidateId);
            ...
            {formData.map((items, index) => (
              <tr className="grades-tr" key={index}>
                <td style={{ width: "20%" }}>
                  ...
                  >
                    <div className="d-flex flex-column w-100 font-size">
                      <span className="text-capitalize">{items?.courseName || "N/A" }</span>
                ...
                <td style={{ width: "20%" }}>
                  ...
                  >
                    <div className="d-flex flex-column">
                      <span className="text-capitalize">{items.gradeStatus || "N/A"}</span>
                      <span style={{ fontSize: "0.65rem", opacity: 0 }}>
                        Error
                      </span>
                    </div>
