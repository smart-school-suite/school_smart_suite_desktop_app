import { useDeleteSchoolAcademicYear } from "../../hooks/academicYear/useDeleteSchoolAcademicYear";
import { CircleX } from "lucide-react";
import { SingleSpinner } from "../../components/Spinners/Spinners";
function DeleteAcademicYear({ drawerData, handleClose }) {
  const { mutate: deleteYear, isPending } =
    useDeleteSchoolAcademicYear(handleClose);
  const handleDeleteSchoolYear = async () => {
    deleteYear(drawerData.id);
  };
  return (
    <>
      <div className="w-100">
