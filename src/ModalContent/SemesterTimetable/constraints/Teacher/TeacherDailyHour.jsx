...
function TeacherDailyHour({ handleClose }) {
  return (
    <>
      <div className="d-flex flex-column gap-3">
        <div className="d-flex flex-row align-items-center justify-content-between w-100">
          <span className="m-0">Teacher Daily Hour</span>
          <span
            className="m-0"
            onClick={() => {
              handleClose();
        ...
        <div className="d-flex flex-column gap-3 modal-content-container px-2">
          ...
          <div className="d-flex flex-column gap-2">
            <label htmlFor="breakPeriodDaysException" className="font-size-sm">
              Teacher Daily Hour Exception (optional)
            </label>
...
export default TeacherDailyHour;
