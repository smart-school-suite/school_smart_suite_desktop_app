...
function TeacherRequestedTimeSlot({ handleClose }) {
  return (
    <>
      <div className="d-flex flex-column gap-3">
        ...
        <div className="d-flex flex-row gap-2">
          <input type="search" placeholder="search teacher" className="form-control font-size-sm w-75" />
          <div className="w-25">
            <button className="border-none bg-white border rounded-pill p-2 font-size-sm w-100 d-flex flex-row align-items-center justify-content-around">
            <span>Select Time Format</span>
            <span><Icon icon="mi:chevron-down" width="16" height="16" /></span>
          </button>
          </div>
        </div>
            ...
            <Fragment key={index}>
              <div className="d-flex flex-column gap-4">
                <div className="d-flex flex-row align-items-center gap-2">
                  <div>
                    <img src="./images/user.png" alt="user-image" style={{
                       width:"2.5rem",
                       height:"2.5rem"
                    }}/>
                  </div>
                ...
                <div className="d-flex flex-column gap-2">
                  ...
                  <div className="d-flex flex-row gap-2">
                    {daysOfWeek.map((items, index) => (
                      <Fragment key={index}>
                        <button
                          className="border-none rounded-pill font-size-sm w-100 py-2"
                        >
...
export default TeacherRequestedTimeSlot;
