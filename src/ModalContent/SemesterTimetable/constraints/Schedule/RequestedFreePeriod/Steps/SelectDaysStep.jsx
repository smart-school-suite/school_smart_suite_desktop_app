...
function SelectDaysStep({
  ...
  const rFDays = useSelector(
    (state) =>
      state.semesterTimetable.soft_constraints.requested_free_periods.days,
  );
    ...
    <>
      <div className="px-2 d-flex flex-column gap-4">
        <div className="d-flex flex-row align-items-center justify-content-between">
          <span className="fw-semibold">Select Days</span>
          <span
            onClick={() => {
              handleClose();
            }}
        ...
        <div className="modal-content-container">
          <div className="d-flex flex-column gap-3">
            <div className="font-size-sm d-flex flex-row align-items-center justify-content-between">
              <p style={{ width: "500px" }}>
                Choose the days where students should have intentional free
                periods.
              </p>
            ...
            <div className="card p-2 rounded-4 d-flex flex-column gap-2">
              ...
              <div className="d-flex flex-column font-size-sm">
                <ul>
                  <li>
                    After selecting days, you'll define the exact times that
            ...
            <div className="d-flex flex-row flex-wrap gap-4 justify-content-center">
              {opDays.length >= 1
                ? opDays
                    .filter((items) => !rFDays.includes(items))
                    .map((items, index) => {
                      return (
                        <Fragment key={index}>
                          <button
                ...
                : daysOfWeek
                    .filter((items) => !rFDays.includes(items.value))
                    .map((items, index) => {
                      return (
                        <Fragment key={index}>
                          <button
