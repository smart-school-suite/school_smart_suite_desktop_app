...
import { useAutoGenResitExamTimetable } from "../../hooks/resitExamTimetable/useAutoGenResitExamTimetable";
...
export default AutoGenResitExamTimetable;
          ...
          <div className="d-flex flex-row align-items-center justify-content-end my-2 gap-2">
            ...
            <button
              ...
              onClick={() => {
                ...
                createTimetable({
                  resitExamId: rowData.id,
                  createData: { entries: payload },
                });
              }}
            >
