...
function UpdateSchoolName({ handleClose }) {
  ...
  const { mutate: updateSchoolName, isPending } = useUpdateSchool(
    handleClose,
    "school name"
  );
      ...
      <div>
        <div className="block">
          <div className="d-flex flex-row align-items-center justify-content-between mb-3">
            <span className="m-0">Update School Name</span>
            <span
              className="m-0"
              onClick={() => {
                handleClose();
        ...
        <div className="my-1">
          ...
          <TextInput
            ...
            validationSchema={nameSchema({
              ...
              required: false,
              message: {
                min: "School Name Must Be Atleast 3 Characters Long",
                max: "School Name Must Not Exceed 150 Characters",
              },
            })}
            value={formData.name}
            type="text"
