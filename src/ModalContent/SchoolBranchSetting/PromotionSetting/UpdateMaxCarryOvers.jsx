...
function UpdateMaxCarryOvers({ handleClose, rowData }) {
  ...
  return (
    <>
      ...
      <div className="w-100">
        ...
        <TextInput
          ...
          validationSchema={numberSchema({
            ...
            integerOnly: true,
            messages: {
              max: "Carry Overs Must Not Exceed 10",
              min: "Carry Overs Must Not Be Less Than 0",
            },
          })}
      ...
      <button
        ...
        disabled={isPending}
      >
        {isPending ? <SingleSpinner /> : "Update Max Carry Overs"}
      </button>
    </>
  );
}
export default UpdateMaxCarryOvers;
