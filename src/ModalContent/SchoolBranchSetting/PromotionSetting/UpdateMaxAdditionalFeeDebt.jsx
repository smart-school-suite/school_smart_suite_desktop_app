...
function UpdateMaxAdditionalFeeDebt({ handleClose, rowData }) {
  ...
  return (
    <>
      <div className="d-flex flex-row align-items-center justify-content-between mb-3 w-100">
        <span className="m-0">Update Max Additional Fee Debt</span>
        <span
          className="m-0"
          onClick={() => {
            handleClose();
      ...
      <div className="w-100">
        ...
        <InputGroup
          ...
          validationSchema={numberSchema({
            ...
            required: false,
            messages: {
              max: `Additional Fees Debt Must Not Exceed 100000 ${currency}`,
              min: `Additional Fees Debt must be  Atleast 1 ${currency}`,
            },
          })}
      ...
      <button
        ...
        disabled={isPending}
      >
        {isPending ? <SingleSpinner /> : "Update Additional Fee Debt"}
      </button>
    </>
  );
}
export default UpdateMaxAdditionalFeeDebt;
