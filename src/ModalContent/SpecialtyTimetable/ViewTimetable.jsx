  ...
  return (
    <>
      ...
      {isPending ? (
        ...
        <div className={`${darkMode ? 'border-none dark-bg' : 'bg-white'} card grades-box rounded-3`}>
...
function SlotCard({
  ...
  return (
    <>
      <div className={`${darkMode ? 'dark-bg-light dark-mode-text' : 'primary-background-50 primary-color-dark'} card p-2 w-100 rounded-3 d-flex flex-column gap-3  border-none `}>
