...
import { useDeactivateBatch } from "../../hooks/studentBatch/useDeactivateBatch";
import { CircleX } from "lucide-react";
function DeactivateBatch({ handleClose, rowData }) {
      ...
      <div className="w-100">
        ...
        >
          <div className="d-flex flex-row align-items-center justify-content-between">
            <div>
              <span className="font-size-sm fw-semibold">Deactivate Batch</span>
            </div>
            <button
              onClick={() => handleClose()}
