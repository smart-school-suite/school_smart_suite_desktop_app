...
import { useReinstateDropOutStudent } from "../../hooks/student/useReinstateDropOutStudent";
import { CircleX } from "lucide-react";
function ReinistateStudent({ handleClose, rowData }) {
  const studentId = rowData.id;
  const { mutate: reinstateStudent, isPending } = useReinstateDropOutStudent(
    handleClose,
    studentId,
  );
