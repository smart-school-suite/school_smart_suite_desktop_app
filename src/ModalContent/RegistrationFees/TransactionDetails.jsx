       ...
       <div className="modal-content-container">
        ...
        <div className="d-flex align-items-center justify-content-between my-1 w-100">
          <div className="py-2">
            ...
            <p className="my-0 gainsboro-color font-size-sm">{transactionDetails?.data?.registration_fee?.student?.name}</p>
          </div>
        </div>
        <hr />
        <div className="d-flex align-items-center justify-content-between my-1 w-100">
          <div className="py-2">
            ...
            <p className="my-0 gainsboro-color font-size-sm">{transactionDetails?.data?.registration_fee?.specialty?.specialty_name}</p>
          </div>
        </div>
        <hr />
        <div className="d-flex align-items-center justify-content-between my-1 w-100">
          <div className="py-2">
            ...
            <p className="my-0 gainsboro-color font-size-sm">{transactionDetails?.data?.registration_fee?.level?.name}</p>
          </div>
        </div>
        <hr />
        <div className="d-flex align-items-center justify-content-between my-1 w-100">
