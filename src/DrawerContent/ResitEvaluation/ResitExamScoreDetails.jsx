import { useGetResitScoresByCandidateId } from "../../hooks/resitScore/useGetResitScoresByCandidateId";
...
function ResitExamScoreDetails({ drawerData, handleClose }) {
  const { id: candidateId } = drawerData;
  const { data: resitScores, isLoading, error } = useGetResitScoresByCandidateId(candidateId);
  return (
    <>
      <div
        ...
        {isLoading ? (
          ...
          <>
            ...
            <div className="drawer-content px-2">
              <div className="d-flex flex-column gap-2">
                {resitScores?.data?.scores?.map((score) => (
                          ...
                          <div className="d-flex flex-column">
                            ...
                            <div className="d-flex flex-row align-items-baseline gap-1">
                              ...
                              <span className="font-size-sm text-muted tabular-numbers">
                                {resitScores?.data?.resit_exam?.max_score}
                              </span>
                            </div>
                          </div>
                        </div>
                ...
                <div className="mt-auto w-100 pt-2 d-flex flex-column gap-2 px-2 pb-3">
                  <div className="d-flex flex-row justify-content-between align-items-center w-100">
                    ...
                    <div className="d-flex flex-row align-items-baseline gap-1">
                      <span className="fw-bold font-size-md tabular-numbers">
                        <NumberFlow
                          value={resitScores?.data?.summary?.gpa ?? 0}
                        />
                      </span>
                      <span>/</span>
                  ...
                  <div className="d-flex flex-row justify-content-between align-items-center w-100">
                    ...
                    <span className="fw-bold font-size-sm">
                      {resitScores?.data?.summary?.courses_failed}
                    </span>
                  </div>
                  <div className="d-flex flex-row justify-content-between align-items-center w-100">
                    <span className="text-muted font-size-sm">
                    ...
                    <span className="fw-bold font-size-sm">
                      {resitScores?.data?.summary?.courses_passed}
                    </span>
                  </div>
                  <div className="d-flex flex-row justify-content-between align-items-center w-100">
                    <span className="text-muted font-size-sm">
                    ...
                    <span>
                      {resitScores?.data?.summary?.total_grade_points_earned}
                    </span>
                  </div>
                </div>
              </div>
...
export default ResitExamScoreDetails;
