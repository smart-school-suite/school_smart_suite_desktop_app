        ...
        {isLoading ? (
          ...
          <>
            ...
            <div className="drawer-content px-2">
              <div className="d-flex flex-column gap-2">
                {examScores?.data?.scores?.map((score) => (
                          ...
                          <div className="d-flex flex-column">
                            ...
                            <div className="d-flex flex-row align-items-baseline gap-1">
                              ...
                              <span className="font-size-sm text-muted tabular-numbers">
                                {examScores?.data?.exam?.max_score}
                              </span>
                            </div>
                          </div>
                        </div>
              ...
              <div className="d-flex flex-column w-100">
                ...
                <div className="mt-auto w-100 pt-2 d-flex flex-column gap-2 px-2 pb-3">
                  <div className="d-flex flex-row justify-content-between align-items-center w-100">
                    ...
                    <div className="d-flex flex-row align-items-baseline gap-1">
                      <span className="fw-bold font-size-md tabular-numbers">
                        <NumberFlow value={examScores?.data?.summary?.gpa ??  0} />
                      </span>
                      <span>/</span>
                  ...
                  <div className="d-flex flex-row justify-content-between align-items-center w-100">
                    ...
                    <span className="fw-bold font-size-sm">{examScores?.data?.summary?.courses_failed}</span>
                  </div>
                  <div className="d-flex flex-row justify-content-between align-items-center w-100">
                    <span className="text-muted font-size-sm">
                      Courses Passed
                    </span>
                    <span className="fw-bold font-size-sm">{examScores?.data?.summary?.courses_passed}</span>
                  </div>
                  <div className="d-flex flex-row justify-content-between align-items-center w-100">
                    <span className="text-muted font-size-sm">Total Grade Point Earned</span>
                    <span>{examScores?.data?.summary?.total_grade_points_earned}</span>
                  </div>
                </div>
              </div>
            </div>
