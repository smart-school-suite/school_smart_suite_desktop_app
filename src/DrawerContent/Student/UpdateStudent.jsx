...
function UpdateStudent({ drawerData, handleClose }) {
  ...
  return (
    <>
      {isStudentDetailsLoading ? (
        <div className="d-flex flex-column w-100 gap-3 px-2 pt-3">
          {[...Array(6)].map((_, index) => (
        ...
        <NotFoundError
          title={studentDetailError?.response?.data?.errors?.title}
          description={studentDetailError?.response?.data?.errors?.description}
        ></NotFoundError>
      ) : (
        <div
          ...
          <div className="drawer-content px-2 pt-3">
            <div className="d-flex flex-column gap-4">
              ...
              <div className="d-flex flex-row align-items-center gap-2 w-100">
                ...
                <div className="w-50">
                  <label
                    htmlFor="studentSource"
                    className="font-size-sm fw-medium"
                  >
                    Student Source
                  </label>
                  <CustomDropdown
