...
function CreateSpecialty({ handleClose }) {
  ...
  const { mutate: createSpecialtyMutation, isPending } =
    useCreateSpecialty(handleClose);
  const { data: educationLevels, isLoading: educationIsLoading } =
    useGetLevels();
  ...
  const handlePrevalidation = async () => {
    ...
    const registrationFee =
      await registrationFeeRef.current.triggerValidation();
  ...
  return (
    <>
      <div className="drawer-content font-size-sm px-2 pt-2">
        <div className="d-flex flex-column gap-3">
          ...
          <div className="d-flex flex-row w-100 gap-2">
            <div className="w-50">
              <label htmlFor="registrationFeeRef" className="font-size-sm">
                Registration Fees
              </label>
              <InputGroup
            ...
            <div className="w-50">
              <label htmlFor="schoolFeesRef" className="font-size-sm">
                School Fees
              </label>
              <InputGroup
                ref={schoolFeesRef}
          ...
          <div>
            ...
            <CustomDropdown
              ...
              direction="up"
              onSelect={(value) =>
                handleStateChange("department_id", value, setFormData)
              }
              placeholder="Select Department"
              error={errors.department_id}
              onError={(value) =>
                handleStateChange("department_id", value, setErrors)
              }
          ...
          <div>
            ...
            <CustomDropdown
              ...
              direction="up"
              onSelect={(value) =>
                handleStateChange("level_id", value, setFormData)
              }
              placeholder="Select Level"
              error={errors.level_id}
              onError={(value) =>
                handleStateChange("level_id", value, setErrors)
              }
