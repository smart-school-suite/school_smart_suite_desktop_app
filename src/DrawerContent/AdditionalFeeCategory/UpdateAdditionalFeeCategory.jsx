...
function UpdateAdditionalFeeCategory({ handleClose, drawerData }) {
  const { id: categoryId, title, description } = drawerData;
          ...
          <div>
            ...
            <TextInput
              ...
              onValidationChange={(value) =>
                handleStateChange("title", value, setFieldValid)
              }
