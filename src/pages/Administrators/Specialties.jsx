...
} from "../../Slices/administrator/specialtySlice";
...
function Specialties() {
  ...
  const specialtyState = useSelector((state) => state.specialty);
              ...
              <div className="h-100">
                <div className="d-flex flex-row align-items-start w-100 h-100 gap-1">
                  <motion.div
                    ...
                    style={{
                      width: specialtyState.isGeneralFilterOpen
                        ? "60%"
                        : "100%",
                    }}
                  >
                  ...
                  {specialtyState.isGeneralFilterOpen && (
                    <AnimatePresence mode="popLayout">
                      {specialtyState.isGeneralFilterOpen && (
                        ...
                        >
                          ...
                          >
                            {specialtyState.customFilter.length > 0 ? (
                              <div>
                                {specialtyState?.customFilter?.map(
                                  (cFilters) => (
                                    <Fragment key={cFilters.id}>
                                      <GeneralFilterWizzard
                                        cFilters={cFilters}
                                        columns={columns}
                                        moduleState={specialtyState}
