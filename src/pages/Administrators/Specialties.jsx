...
import { resetAllCustomFilters, addCustomFilter, toggleGeneralFilter, removeCustomFilter, setCustomFilter } from "../../Slices/administrator/specialtySlice";
              ...
              <div className="h-100">
                <div className="d-flex flex-row align-items-start w-100 h-100 gap-1">
                  <motion.div
                    ...
                    style={{
                      width: specialtyState.isGeneralFilterOpen ? "60%" : "100%",
                    }}
                  >
                    <Table
                        ...
                        >
                          ...
                          >
                            {specialtyState.customFilter.length > 0 ? (
                              <div>
                                {specialtyState?.customFilter?.map((cFilters) => (
