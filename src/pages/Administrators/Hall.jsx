                ...
                <div className="h-100">
                  <div className="d-flex flex-row align-items-start w-100 h-100 gap-1">
                    <motion.div
                      ...
                      style={{
                        width: hallState.isGeneralFilterOpen ? "60%" : "100%",
                      }}
                    >
                      <Table
                          ...
                          >
                            ...
                            >
                              ...
                              <div className="d-flex flex-row align-items-center justify-content-between">
                                ...
                                <span>{halls?.data.length} items</span>
                              </div>
                            </div>
                            <div
                            ...
                            >
                              {hallState.customFilter.length > 0 ? (
                                <div>
                                  {hallState?.customFilter?.map((cFilters) => (
                                    <Fragment key={cFilters.id}>
                                      <GeneralFilterWizzard
                                        cFilters={cFilters}
                                        columns={columns}
                                        moduleState={hallState}
