...
import PayTuitionFee from "../../DrawerContent/TuitionFee/PayTuitionFee";
import React, {
  useState,
  useMemo,
  useCallback,
...
import {
  ...
  removeCustomFilter,
  setCustomFilter,
} from "../../Slices/tuitionFee/tuitionFeeSlice";
...
function TuitionFees() {
  ...
  const tuitionFeeState = useSelector((state) => state.tuitionFee);
  ...
  const handleRowDataFromChild = useCallback((Data) => {
    setSelectedTuitionFees(Data);
  }, []);
  const handleRowCountFromChild = useCallback((count) => {
    setRowCount(count);
  }, []);
  const memoizedColDefs = useMemo(() => {
    return tuitionFeeColDefs({
      ActionComponent,
    });
  }, []);

  const memoizedRowData = useMemo(() => {
    return tuitionFees?.data ?? [];
  }, [tuitionFees]);
            ...
            <>
              <div className="d-flex flex-column gap-2 h-100">
                ...
                <div className="d-flex flex-row justify-content-between align-items-center">
                  <div className="w-50">
                    <SearchInput
                      placeholder={"Search Tuition Fee......"}
                      value={searchText}
                ...
                <div className="h-100">
                  <div className="d-flex flex-row align-items-start w-100 h-100 gap-1">
                    <motion.div
                      ...
                      style={{
                        width: tuitionFeeState.isGeneralFilterOpen
                          ? "60%"
                          : "100%",
                      }}
                    >
                    ...
                    {tuitionFeeState.isGeneralFilterOpen && (
                        ...
                        {tuitionFeeState.isGeneralFilterOpen && (
                          ...
                          >
                            ...
                            >
                              <div className="d-flex flex-row align-items-center justify-content-between">
                                <span>
                                  Build a custom view of your Tuition fee data.
                                </span>
                                <button
                              ...
                              <div className="d-flex flex-row align-items-center justify-content-between">
                                <div className="d-flex flex-row align-items-center gap-2">
                                  ...
                                  <span>Filter Tuition Fee</span>
                                </div>
                                <span>{tuitionFees?.data.length} items</span>
                              </div>
                            </div>
                            <div
                            ...
                            >
                              {tuitionFeeState.customFilter.length > 0 ? (
                                <div>
                                  {tuitionFeeState?.customFilter?.map(
                                    (cFilters) => (
                                      <Fragment key={cFilters.id}>
                                        <GeneralFilterWizzard
                                          cFilters={cFilters}
                                          columns={columns}
                                          moduleState={tuitionFeeState}
                                          removeCustomFilter={
                                            removeCustomFilter
                                          }
    ...
    <>
      ...
      >
        <DropDownMenuItem
          ...
          onClick={() =>
            handleShowDrawer(PayTuitionFee, {
