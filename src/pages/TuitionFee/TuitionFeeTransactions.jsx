            ...
            <>
              <div className="d-flex flex-column gap-2 h-100">
                ...
                <div className="d-flex flex-row justify-content-between align-items-center">
                  <div className="w-50">
                    <SearchInput
                      placeholder={"Search Tuition Fee Transaction......"}
                      value={searchText}
                        ...
                        {tuitionFeeTransacState.isGeneralFilterOpen && (
                          ...
                          >
                            ...
                            >
                              <div className="d-flex flex-row align-items-center justify-content-between">
                                <span>
                                  Build a custom view of your Tuition fee
                                  Transaction data.
                                </span>
                                <button
  ...
  return (
    <>
      <DropDownMenuItem
        ...
        onClick={() =>
          handleShowModal(BulkReverseTuitionFeeTransaction, {
            size: "md",
            closeOnOutsideClick: true,
            closeOnEscape: true,
          })
      ...
      <DropDownMenuItem
        className="remove-button-styles w-100 border-none transparent-bg p-0 rounded-2 pointer-cursor"
        onClick={() =>
          handleShowModal(BulkDeleteTuitionFeeTransaction, {
            size: "md",
            closeOnOutsideClick: true,
            closeOnEscape: true,
          })
