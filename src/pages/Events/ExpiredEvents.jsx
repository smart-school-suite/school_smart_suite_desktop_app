...
import { useGetExpiredSchoolEvents } from "../../hooks/schoolEvent/useGetExpiredSchoolEvents";
import { useGetExpiredSchoolEventsByCategory } from "../../hooks/schoolEvent/useGetExpiredSchoolEventsByCategory";
...
function AllEvents() {
  const { data: schoolEvents, isLoading, error } = useGetExpiredSchoolEvents();
  return (
    <>
      {isLoading ? (
...
function CategorizedEvents({ categoryId }) {
  const {
    ...
    isLoading,
    error,
  } = useGetExpiredSchoolEventsByCategory(categoryId);
  return (
    <>
      {isLoading ? (
        <div className="d-flex flex-column gap-2 w-100">
