...
import UpdateExpenseCategory from "../../DrawerContent/ExpenseCategory/UpdateExpenseCategory";
import CreateExpenseCategory from "../../DrawerContent/ExpenseCategory/CreateExpenseCategory";
...
import { expenseCategoryColDefs } from "../../utils/table/colDefs/schoolExpense/expenseCategoryColDefs";
import { useSelector, useDispatch } from "react-redux";
import ExpenseCategoryDetails from "../../DrawerContent/ExpenseCategory/ExpenseCategoryDetails";
function SchoolExpensesCategory() {
  const dispatch = useDispatch();
  const tableRef = useRef(null);
  const tableWrapperRef = useRef(null);
  const moduleState = useSelector((state) => state.expenseCategory);
  const { data: category, isLoading, error } = useGetExpensesCategories();
                ...
                <div className="d-flex flex-row justify-content-between align-items-center">
                  ...
                  <div className="d-flex flex-row align-items-center gap-2">
                    <DrawerTrigger
                      ...
                      placement="right"
                      drawerChildren={CreateExpenseCategory}
                      showHeader={true}
                        ...
                        {moduleState.isGeneralFilterOpen && (
                          ...
                          >
                            ...
                            >
                              <div className="d-flex flex-row align-items-center justify-content-between">
                                <span>
                                  Build a custom view of your Expense Category
                                  data.
                                </span>
                                <button
   ...
   <ActionButtonDropdown
      ...
      >
        <DropDownMenuItem
          ...
          onClick={() =>
            handleShowDrawer(UpdateExpenseCategory, {
        ...
        <DropDownMenuItem
          ...
          onClick={() =>
            handleShowModal(DeleteCategory, {
              size: "md",
              closeOnOutsideClick: true,
              closeOnEscape: true,
            })
        ...
        <DropDownMenuItem
          ...
          onClick={() =>
            handleShowDrawer(ExpenseCategoryDetails, {
