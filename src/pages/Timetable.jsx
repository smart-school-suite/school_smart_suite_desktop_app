         ...
         />
           <div className="d-flex flex-row align-items-center justify-content-between my-2">
            <div className="d-fl py-2 px-2 d-flex flex-row align-items-center justify-content-center gap-3 rounded-3 align-items-center gap-2">
                ...
                <h5 className="my-0 fw-semibold">Specailty TimeTable</h5>
            </div>
        ...
        <td className="border-top">
          <div className="d-flex flex-row justify-content-between w-100">
            <div className="d-flex flex-row align-items-center gap-2">
                    <button className="border-none d-flex py-2 px-2  primary-background text-white transition-3s flex-row align-items-center justify-content-center gap-4 rounded-3 align-items-center" 
                    >
                <div className="d-block text-start">
                  <p className="my-0">Jan</p>
                  <p className="my-0 font-size-sm text-capitalize">2023</p>
                </div>
                <h1 className="my-0 fw-bold">1</h1>
              </button>
            </div>
