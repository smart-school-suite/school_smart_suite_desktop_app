...
function Timetable() {
  ...
  const handleSelect = (value) => {
    ...
    toast.success(`Selected Specialty: ${value.id} level id: ${value.level_id}`);
  };

  const { data: specialty, error: specialtyError, isLoading: specialtyLoading } = useFetchSpecialtiesQuery();
  ...
  const filter_array_keys = ["id", "specialty_name", "level.name", "level.level", "level.id"];
  const renameMapping = {
      ...
      <div className="card py-2 rounded-4 w-100">
        <div className="d-flex flex-row justify-content-between align-items-center w-100 px-2">
          ...
          <div className="d-flex flex-row align-items-center gap-3">
            <CustomTooltip
             tooltipText={"Download Time Table"}
            >
            <button
                  ...
                  <tr key={index}>
                    <td className="first-column">
                      <div className="d-flex flex-column justify-content-center">
                        <p className="my-0 text-end font-size-sm text-uppercase">{day}</p>
                      </div>
                    </td>
                    <td>
                      <div className="d-flex flex-row align-items-center justify-content-between" style={{ width: "70vw" }}>
