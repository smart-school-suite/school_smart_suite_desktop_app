...
function School() {
  ...
  const { data: schoolDetails, isLoading, error } = useGetSchoolDetails();
  return (
    <>
      <div
          ...
          <div className="d-flex flex-column justify-content-start gap-2 w-100">
            <div className="w-100 d-flex flex-row align-items-center justify-content-end">
              <button className="border-none p-3 rounded-3 font-size-sm d-flex flex-row gap-3 primary-background-100 color-primary">
                ...
                <span className="m-0">Create New School Branch</span>
              </button>
            </div>
            <div>
              <span
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <span className="fw-light">{schoolDetails.data.name}</span>
                  </div>
                  <div>
                ...
                <div
                  className={`${
                    darkMode ? "gainsboro-color" : null
                  } d-flex flex-row align-items-center justify-content-between pointer-cursor remove-button-style`}
                >
                  <div
                    className={`${
                      darkMode ? "gainsboro-color" : null
