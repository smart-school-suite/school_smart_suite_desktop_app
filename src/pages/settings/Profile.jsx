...
function Profile() {
  ...
  return (
    <>
      ...
      >
        <div
          className={`${darkMode ? "dark-bg" : "white-bg"} card border-none pb-4  rounded-4 profile-section d-flex flex-column`}
        >
        ...
        <div>
          ...
          <div
            className={`${darkMode ? "dark-bg" : "white-bg"} card border-none px-2 py-3 rounded-4`}
          >
            <ModalButton
            ...
            >
              <div className="d-flex flex-column text-start">
                ...
                <span className="gainsboro-color fw-light">
                  {schoolAdmin.data.authSchoolAdmin.name === null
                    ? "Add Full Names"
                    : schoolAdmin.data.authSchoolAdmin.name}
                </span>
              </div>
            ...
            >
              <div className="d-flex flex-column text-start">
                ...
                <span className="gainsboro-color fw-light">
                  {schoolAdmin.data.authSchoolAdmin.first_name === null
                    ? "Add First Name"
            ...
            >
              <div className="d-flex flex-column text-start">
                ...
                <span className="gainsboro-color fw-light">
                  {schoolAdmin.data.authSchoolAdmin.last_name === null
                    ? "Add Last Name"
            ...
            >
              <div className="d-flex flex-column text-start">
                ...
                <span className="gainsboro-color fw-light">
                  {schoolAdmin.data.authSchoolAdmin.date_of_birth === null
                    ? "Add Date Of Birth"
                    : formatDate(
                        schoolAdmin.data.authSchoolAdmin.date_of_birth,
                      )}
                </span>
              </div>
              <div>
            ...
            >
              <div className="d-flex flex-column text-start">
                ...
                <span className="gainsboro-color fw-light">
                  {schoolAdmin.data.authSchoolAdmin.cultural_background === null
        ...
        <div>
          ...
          <div
            className={`${darkMode ? "dark-bg" : "white-bg"} card border-none rounded-4 px-2 py-3`}
          >
            <ModalButton
              classname={`${darkMode ? "gainsboro-color" : null} d-flex flex-row align-items-center justify-content-between font-size-sm w-100 remove-button-style`}
            ...
            >
              <div className="d-flex flex-column text-start">
                ...
                <span className="gainsboro-color fw-light">
                  {schoolAdmin.data.authSchoolAdmin.email === null
                    ? "Add Email"
            ...
            >
              <div className="d-flex flex-column text-start">
                ...
                <span className="gainsboro-color fw-light">
                  {schoolAdmin.data.authSchoolAdmin.phone_one === null
                    ? "Add Contact One"
            ...
            >
              <div className="d-flex flex-column text-start">
                ...
                <span className="gainsboro-color fw-light">
                  {schoolAdmin.data.authSchoolAdmin.phone_two === null
                    ? "Add Contact Two"
          ...
          >
            ...
            >
              <div className="d-flex flex-column text-start">
                ...
                <span className="gainsboro-color fw-light">
                  {schoolAdmin.data.authSchoolAdmin.address === null
                    ? "Add Contact Two"
