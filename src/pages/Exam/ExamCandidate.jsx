...
function ExamCandidates() {
  ...
  const examCandidateState = useSelector((state) => state.examCandidate);
  ...
  const memoizedColDefs = useMemo(() => {
    return examCandidateColDefs({
      ActionComponent,
    });
  }, []);

  const memoizedRowData = useMemo(() => {
    return examCandidates?.data ?? [];
  }, [examCandidates]);
              ...
              <div className="h-100">
                <div className="d-flex flex-row align-items-start w-100 h-100 gap-1">
                  <motion.div
                    ...
                    style={{
                      width: examCandidateState.isGeneralFilterOpen
                        ? "60%"
                        : "100%",
                    }}
                  >
                  ...
                  {examCandidateState.isGeneralFilterOpen && (
                        ...
                        >
                          ...
                          >
                            ...
                            <div className="d-flex flex-row align-items-center justify-content-between">
                              ...
                              <span>{examCandidates?.data.length} items</span>
                            </div>
                          </div>
                          <div
                          ...
                          >
                            {examCandidateState.customFilter.length > 0 ? (
                              <div>
                                {examCandidateState?.customFilter?.map(
                                  (cFilters) => (
                                    <Fragment key={cFilters.id}>
                                      <GeneralFilterWizzard
                                        cFilters={cFilters}
                                        columns={columns}
                                        moduleState={examCandidateState}
