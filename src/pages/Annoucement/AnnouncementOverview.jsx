    ...
    <>
      {isLoading ? (
        ...
        <section className="w-100 h-100 d-flex flex-column gap-1">
          <div style={{ height: "22%" }} className="d-flex flex-column gap-2">
            ...
            <div className="d-flex flex-row gap-2 align-items-center w-100 h-100">
              <div
              ...
              >
                ...
                <div className="mt-auto fw-semibold">
                  <span style={{ fontSize: "2rem" }}>
                    {
                      announcementStats.data.total_announcement_numbers
            ...
            <div className="d-flex flex-row align-items-center gap-2 w-100 h-100">
              <div className="w-50 d-flex flex-column gap-2 h-100">
                ...
                <div className="announcement-dashboard-content d-flex flex-column gap-2 px-1">
                  {announcementStats.data.recent_announcements_by_status.active_announcement.map(
                    (items) => (
                      <div
                        className={`${
                          darkMode ? "dark-bg dark-mode-text" : "white-bg"
                        } card border-none shadow-sm font-size-sm rounded-4 p-2 d-flex flex-column gap-3`}
                        key={items.id}
                      >
                        ...
                        <div className="d-flex flex-column">
                          ...
                          <div className="d-flex align-items-center gap-1 ">
                            ...
                            <span className="font-size-sm">
                              {formatISODate(items.expires_at)}
                            </span>
                          </div>
                        </div>
                      </div>
              ...
              <div className="w-50 d-flex flex-column gap-2 h-100">
                ...
                <div className="announcement-dashboard-content d-flex flex-column gap-2 px-1">
                  {announcementStats.data.recent_announcements_by_status.scheduled_announcement.map(
                    (items) => (
                      <div
                        className={`${
                          darkMode ? "dark-bg dark-mode-text" : "white-bg"
                      ...
                      >
                        ...
                        <div className="d-flex flex-column">
                          ...
                          <div className="d-flex align-items-center gap-1 ">
                            <Icon icon="solar:calendar-outline" />
                            <span className="font-size-sm">
                              {formatISODate(items.published_at)}
                            </span>
                          </div>
                        </div>
                      </div>
          ...
          <section style={{ height: "15%" }}>
            ...
            <div className="d-flex flex-row align-items-center gap-2">
              <div
                className={`${
                  darkMode ? "dark-bg dark-mode-text" : "white-bg"
                } card border-none d-flex flex-row font-size-sm p-2 rounded-2 w-25`}
              >
                <div className="d-flex flex-row gap-2">
                  ...
                  <div className="d-flex flex-column">
                    <span>Important</span>
                    <span className="fs-6 fw-semibold">{announcementStats.data.announcement_numbers_by_type[0].count}</span>
                  </div>
                </div>
              </div>
              <div
              ...
              >
                <div className="d-flex flex-row gap-2">
                  ...
                  <div className="d-flex flex-column">
                    <span>Urgent</span>
                    <span className="fs-6 fw-semibold">{announcementStats.data.announcement_numbers_by_type[1].count}</span>
                  </div>
                </div>
              </div>
              <div
              ...
              >
                <div className="d-flex flex-row gap-2">
                  ...
                  <div className="d-flex flex-column">
                    <span>info</span>
                    <span className="fs-6 fw-semibold">{announcementStats.data.announcement_numbers_by_type[3].count}</span>
                  </div>
                </div>
              </div>
              <div
              ...
              >
                <div className="d-flex flex-row gap-2">
                  ...
                  <div className="d-flex flex-column">
                    <span>Draft</span>
                    <span className="fs-6 fw-semibold">{announcementStats.data.total_announcement_numbers.total_announcement_draft}</span>
                  </div>
                </div>
              </div>
            </div>
...
export default AnnoucementOverView;
