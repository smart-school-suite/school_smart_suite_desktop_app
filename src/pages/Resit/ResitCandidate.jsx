...
import { resitCandidateColDefs } from "../../utils/table/colDefs/resit/resitCandidateColDefs";
...
import {
  ...
  removeCustomFilter,
  setCustomFilter,
} from "../../Slices/resit/resitCandidateSlice";
...
function ResitCandidates() {
  ...
  const resitCandidateState = useSelector((state) => state.resitCandidate);
              ...
              <div className="h-100">
                <div className="d-flex flex-row align-items-start w-100 h-100 gap-1">
                  <motion.div
                    ...
                    style={{
                      width: resitCandidateState.isGeneralFilterOpen
                        ? "60%"
                        : "100%",
                    }}
                  >
                  ...
                  {resitCandidateState.isGeneralFilterOpen && (
                      ...
                      {resitCandidateState.isGeneralFilterOpen && (
                        ...
                        >
                          ...
                          >
                            <div className="d-flex flex-row align-items-center justify-content-between">
                              <span>
                                Build a custom view of your resit Candidates
                                data.
                              </span>
                              <button
                            ...
                            <div className="d-flex flex-row align-items-center justify-content-between">
                              <div className="d-flex flex-row align-items-center gap-2">
                                ...
                                <span>Filter Resit Candidates</span>
                              </div>
                              <span>{resitCandidates?.data.length} items</span>
                            </div>
                          </div>
                          <div
                          ...
                          >
                            {resitCandidateState.customFilter.length > 0 ? (
                              <div>
                                {resitCandidateState?.customFilter?.map(
                                  (cFilters) => (
                                    <Fragment key={cFilters.id}>
                                      <GeneralFilterWizzard
                                        cFilters={cFilters}
                                        columns={columns}
                                        moduleState={resitCandidateState}
...
function ActionButtons({ selectedCandidates, resetAll }) {
  return (
    <>
      <ModalButton
        classname={"border-none transparent-bg w-100 p-0 dark-mode-text"}
        //action={{ modalContent: BulkDeleteTeacher }}
        bulkData={selectedCandidates}
        resetAll={resetAll}
      >
...
function DropdownItems({ selectedCandidates, resetAll }) {
  return (
    <>
      <ModalButton
