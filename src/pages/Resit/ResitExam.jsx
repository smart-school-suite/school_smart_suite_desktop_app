...
import { resitExamColDefs } from "../../utils/table/colDefs/resit/resitExamColDefs";
...
import {
  ...
  removeCustomFilter,
  setCustomFilter,
} from "../../Slices/resit/resitExamSlice";
...
import ConfigureGradeScaleWizzard from "../../DrawerContent/ResitExam/ConfigureGradeScale/ConfigureGradeScaleWizzard";
import UpdateResitExam from "../../DrawerContent/ResitExam/UpdateResitExam";
import DeleteResitExam from "../../ModalContent/ResitExam/DeleteResitExam";
import ResitExamDetails from "../../DrawerContent/ResitExam/ResitExamDetails";
function ResitExam() {
  const { data: resitExams, isLoading, error } = useGetAllResitExams();
  const darkMode = useSelector((state) => state.theme.darkMode);
  const tableWrapperRef = useRef(null);
  const resitExamState = useSelector((state) => state.resitExam);
  ...
  const memoizedColDefs = useMemo(() => {
    return resitExamColDefs({
      ActionComponent,
    });
  }, []);

  const memoizedRowData = useMemo(() => {
    return resitExams?.data ?? [];
  }, [resitExams]);
        ...
        <div className="d-flex flex-column gap-3 h-100">
          <div className="d-flex flex-row align-items-center justify-content-between bg-white p-2 border rounded-3">
            <div className="d-flex align-items-center gap-2">
              ...
              <span className="fw-semibold font-size-sm">Manage Resit Exams</span>
            </div>
              ...
              <div className="h-100">
                <div className="d-flex flex-row align-items-start w-100 h-100 gap-1">
                  <motion.div
                    ...
                    style={{
                      width: resitExamState.isGeneralFilterOpen ? "60%" : "100%",
                    }}
                    ref={tableWrapperRef}
                  >
                    <Table
                  ...
                  {resitExamState.isGeneralFilterOpen && (
                      ...
                      {resitExamState.isGeneralFilterOpen && (
                        ...
                        >
                          ...
                          >
                            <div className="d-flex flex-row align-items-center justify-content-between">
                              <span>
                                Build a custom view of your Exam data.
                              </span>
                              <button
                            ...
                            <div className="d-flex flex-row align-items-center justify-content-between">
                              <div className="d-flex flex-row align-items-center gap-2">
                                ...
                                <span>Filter Resit Exam</span>
                              </div>
                              <span>{resitExams?.data.length} items</span>
                            </div>
                          </div>
                          <div
                          ...
                          >
                            {resitExamState.customFilter.length > 0 ? (
                              <div>
                                {resitExamState?.customFilter?.map((cFilters) => (
                                  <Fragment key={cFilters.id}>
                                    <GeneralFilterWizzard
                                      cFilters={cFilters}
                                      columns={columns}
                                      moduleState={resitExamState}
    ...
    <>
      ...
      >
        <DropDownMenuItem
          ...
          onClick={() =>
            handleShowDrawer(UpdateResitExam, {
              title: "Update Resit Exam",
        ...
        <DropDownMenuItem
          ...
          onClick={() =>
            handleShowModal(DeleteResitExam, {
              size: "md",
              closeOnOutsideClick: true,
              closeOnEscape: true,
            })
        ...
        <DropDownMenuItem
          ...
          onClick={() =>
            handleShowDrawer(ResitExamDetails, {
        ...
        <DropDownMenuItem
          ...
          onClick={() =>
            handleShowDrawer(ConfigureGradeScaleWizzard, {
              title: "Configure Resit Exam Grade Scale",
              closeOnOutsideClick: false,
              showHeader: false,
            })
          }
