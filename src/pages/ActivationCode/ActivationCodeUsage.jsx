...
import {
  ...
  removeCustomFilter,
  setCustomFilter,
} from "../../Slices/activationCode/activationCodeUsageSlice";
...
import { activationCodeUsageColDefs } from "../../utils/table/colDefs/activationCode/activationCodeUsageColDefs";
function ActivationCodeUsage() {
  ...
  const moduleState = useSelector((state) => state.activationCodeUsage);
  ...
  const memoizedColDefs = useMemo(() => {
    return activationCodeUsageColDefs();
  }, []);
            ...
            <>
              <div className="d-flex flex-column gap-2 h-100">
                ...
                <div className="d-flex flex-row justify-content-between align-items-center">
                  <div className="w-50">
                    <SearchInput
                      placeholder={"Search Activation Code Usage......"}
                      value={searchText}
                        ...
                        {moduleState.isGeneralFilterOpen && (
                          ...
                          >
                            ...
                            >
                              <div className="d-flex flex-row align-items-center justify-content-between">
                                <span>
                                  Build a custom view of your Activation Code Usage
                                  data.
                                </span>
                                <button
                              ...
                              <div className="d-flex flex-row align-items-center justify-content-between">
                                <div className="d-flex flex-row align-items-center gap-2">
                                  ...
                                  <span>Filter Activation Code Usage</span>
                                </div>
                                ...
                                <div className="d-flex flex-column justify-content-center align-items-center flex-grow-1 p-4">
                                  <div className="text-center d-flex flex-column gap-1 mb-3">
                                    ...
                                    <span className="text-muted">
                                      ...
                                      down your Activation Code Usage list.
                                    </span>
                                  </div>
                                  <button
