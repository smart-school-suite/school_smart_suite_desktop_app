...
import {
  ...
  removeCustomFilter,
  setCustomFilter,
} from "../../Slices/activationCode/activationCodeTransactionSlice";
...
import { activationCodeTransactionColDefs } from "../../utils/table/colDefs/activationCode/activationCodeTransactionColDefs";
function Transactions() {
  ...
  const moduleState = useSelector((state) => state.activationCodeTransaction);
  ...
  const memoizedColDefs = useMemo(() => {
    return activationCodeTransactionColDefs();
  }, []);
            ...
            <>
              <div className="d-flex flex-column gap-2 h-100">
                ...
                <div className="d-flex flex-row justify-content-between align-items-center">
                  <div className="w-50">
                    <SearchInput
                      placeholder={"Search Activation Code Transactions......"}
                      value={searchText}
                            ...
                            >
                              ...
                              <div className="d-flex flex-row align-items-center justify-content-between">
                                <div className="d-flex flex-row align-items-center gap-2">
                                  ...
                                  <span>
                                    Filter Activation Code Transactions
                                  </span>
                                </div>
                                ...
                                <div className="d-flex flex-column justify-content-center align-items-center flex-grow-1 p-4">
                                  <div className="text-center d-flex flex-column gap-1 mb-3">
                                    ...
                                    <span className="text-muted">
                                      ...
                                      down your Activation Code Transactions
                                      list.
                                    </span>
                                  </div>
                                  <button
