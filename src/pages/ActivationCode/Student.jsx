...
import { studentActivationCodeColDefs } from "../../utils/table/colDefs/activationCode/studentActivationCodeColDefs";
...
import {
  ...
  removeCustomFilter,
  setCustomFilter,
} from "../../Slices/activationCode/studentActivationCodeSlice";
...
function Student() {
  ...
  const moduleState = useSelector((state) => state.studentActivationCode);
  ...
  const memoizedColDefs = useMemo(() => {
    return studentActivationCodeColDefs();
  }, []);
            ...
            <>
              <div className="d-flex flex-column gap-2 h-100">
                ...
                <div className="d-flex flex-row justify-content-between align-items-center">
                  <div className="w-50">
                    <SearchInput
                      placeholder={"Search Student Account......"}
                      value={searchText}
                        ...
                        {moduleState.isGeneralFilterOpen && (
                          ...
                          >
                            ...
                            >
                              <div className="d-flex flex-row align-items-center justify-content-between">
                                <span>
                                  Build a custom view of your Student Account
                                  data.
                                </span>
                                <button
                              ...
                              <div className="d-flex flex-row align-items-center justify-content-between">
                                <div className="d-flex flex-row align-items-center gap-2">
                                  ...
                                  <span>Filter Student Accounts</span>
                                </div>
                                <span>
                                  {memoizedRowData?.length} items
                                </span>
                              </div>
                            </div>
                            <div
                                ...
                                <div className="d-flex flex-column justify-content-center align-items-center flex-grow-1 p-4">
                                  <div className="text-center d-flex flex-column gap-1 mb-3">
                                    ...
                                    <span className="text-muted">
                                      ...
                                      down your Student Account list.
                                    </span>
                                  </div>
                                  <button
