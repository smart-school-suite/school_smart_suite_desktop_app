...
import {
  ...
  removeCustomFilter,
  setCustomFilter,
} from "../../Slices/activationCode/teacherActivationCodeSlice";
...
import { teacherActivationCodeColDefs } from "../../utils/table/colDefs/activationCode/teacherActivationCodeColDefs";
function Teacher() {
  const {
  ...
  const moduleState = useSelector((state) => state.teacherActivationCode);
  ...
  const memoizedColDefs = useMemo(() => {
    return teacherActivationCodeColDefs();
  }, []);
                        ...
                        {moduleState.isGeneralFilterOpen && (
                          ...
                          >
                            ...
                            >
                              <div className="d-flex flex-row align-items-center justify-content-between">
                                <span>
                                  Build a custom view of your Teacher Account
                                  data.
                                </span>
                                <button
                              ...
                              <div className="d-flex flex-row align-items-center justify-content-between">
                                <div className="d-flex flex-row align-items-center gap-2">
                                  ...
                                  <span>Filter Teacher Accounts</span>
                                </div>
                                ...
                                <div className="d-flex flex-column justify-content-center align-items-center flex-grow-1 p-4">
                                  <div className="text-center d-flex flex-column gap-1 mb-3">
                                    ...
                                    <span className="text-muted">
                                      ...
                                      down your Teacher Account list.
                                    </span>
                                  </div>
                                  <button
