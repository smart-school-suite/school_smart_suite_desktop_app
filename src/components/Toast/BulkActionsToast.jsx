...
function BulkActionsToast({ rowCount, label, dropDownItems, actionButton, resetAll }) {
  ...
  return (
    <>
      <div
        className={`z-3 w-100 d-flex flex-column justify-content-center align-items-center table-toast-container
      ...
      >
          ...
          {isToggled && (
            ...
            >
              <div
                className={`${
                  darkMode
                    ? "dark-bg-light dark-mode-text dark-mode-border"
                    : "bg-white border"
                } w-50 d-flex flex-column gap-1 rounded-3 p-1 gap-2 dropdown-content-sm`}
              >
        ...
        <div
          className={`${
            darkMode
              ? "dark-bg-light dark-mode-text dark-mode-border"
              : "bg-white gainsboro-color border"
          } w-50 p-2 rounded-3 d-flex flex-row justify-content-between align-item-center table-toast shadow-sm`}
        >
            ...
            <button
              className={`${
                darkMode
                  ...
                  : "border-none transparent-bg gainsboro-color"
              }`}
