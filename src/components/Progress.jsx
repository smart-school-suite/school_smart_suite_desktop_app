...
import LineChart from "./chartcomponents/Linecharts";
import BarChart from "./chartcomponents/barChart";
import HeatMap from "./chartcomponents/heatMap";
    ...
    return(
        <>
         ...
         <section className="mt-2">
            <div className="d-flex flex-row gap-3 w-100 justify-content-between">
                <div style={{ width:"31.5%", height:"31dvh" }} className="bg-white  rounded-4 p-2">
                <p className="text-start font-size-sm my-0">Percentage of Fees Paid</p>
                <p className="text-wrap font-size-xs my-0">Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptatibus alias adipisicing elit. Voluptatibus alias</p>
                </div>
                <div style={{ width:"31.5%", height:"31dvh" }} className="bg-white  rounded-4 p-2">
