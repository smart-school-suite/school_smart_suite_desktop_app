...
import { SpecialtyIcon, DepartmentIcon, HallIcon, ExamIcon, ExamCandidateIcon } from "../../icons/Icons";
import { useGetCardStats } from "../../hooks/academicAnalytics/useGetCardStats";
import { RepeatIcon } from "../../icons/ActionIcons";
function AcademicCardStats() {
  const { data: cardStats, isLoading, error } = useGetCardStats(2026);
  return (
    <>
      {isLoading ? (
            ...
            <div className="overlay-content z-3 ps-2">
              <div className="z-3 position-absolute d-flex flex-column h-100 pb-2 pt-1">
                <div className="d-flex flex-row align-items-center gap-3 mt-1">
                  ...
                  <span style={{ color: "#142e3d" }}>Total Evaluated Student</span>
                </div>
                <div className="mt-auto">
                  <div>
                    ...
                    >
                      <NumberFlow
                        value={cardStats?.data?.total_evaluated_candidate || 0}
                      />
                    </h4>
                  </div>
                </div>
            ...
            <div className="overlay-content z-3 ps-2">
              <div className="z-3 position-absolute d-flex flex-column h-100 pb-2 pt-1">
                <div className="d-flex flex-row align-items-center gap-3 mt-1">
                  ...
                  <span style={{ color: "#430707" }}>Total Exams</span>
                </div>
                <div className="mt-auto">
                  <div>
                    <h4
                    ...
                    >
                      <NumberFlow
                        value={cardStats?.data?.total_exams || 0}
                      />
                    </h4>
                  </div>
                </div>
            ...
            <div className="overlay-content z-3 ps-2">
              <div className="z-3 position-absolute d-flex flex-column h-100 pb-2 pt-1">
                <div className="d-flex flex-row align-items-center gap-3 mt-1">
                  ...
                  <span style={{ color: "#272f44" }}>Total Resit</span>
                </div>
                <div className="mt-auto">
                  <div>
                    <h4
                      ...
                      style={{ color: "#272f44" }}
                    >
                      <NumberFlow value={cardStats?.data?.total_resits || 0} />
                    </h4>
                  </div>
                </div>
              </div>
...
export default AcademicCardStats;
